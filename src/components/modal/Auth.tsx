...
export default function Auth() {
  return (
    <div>
        <button className="mb-2 w-[180px] flex items-center bg-white h-[32px]">
        ...
        <button className="mb-2 w-[180px] flex items-center bg-white h-[32px]">
            <Image className="mr-2 p-2" src={"/auth_svg/github-mark.svg"} alt="github-login" height={32} width={32} />
